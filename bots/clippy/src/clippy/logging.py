"""Simple logging functionality for Clippy bot."""
...
class Logger:
    """Simple logger for Clippy bot."""
    
    def __init__(self, component: str = "clippy"):
    ...
    def _log(self, level: str, message: str, **kwargs: Any) -> None:
        ...
        log_parts = [f"[{self.component.upper()}]", f"{timestamp}", f"[{level}]", message]
